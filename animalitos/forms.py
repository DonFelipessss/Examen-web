...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['csrfmiddlewaretoken'] = forms.CharField(widget=forms.HiddenInput(), initial=get_token())
    ...
    def clean_email(self):
        ...
        if user:
            raise ValidationError(_('You cannot use this email address.'))
...
class ChangeEmailForm(forms.Form):
    ...
    def clean_email(self):
        ...
        if user:
            raise ValidationError(_('You cannot use this mail.'))
